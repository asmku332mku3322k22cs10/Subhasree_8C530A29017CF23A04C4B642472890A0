"""_Implement a class called BankAccount that represents a bank account.
...
write a program to create an instance of the BankAccount class and test the deposit and withdrawalfunctionality."""
